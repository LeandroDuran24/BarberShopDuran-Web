<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="PeluqueroCons.aspx.cs" Inherits="BarberShop.UI.Consultas.PeluqueroCons" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <h1 class="text-center">Consulta Peluqueros <span class="glyphicon glyphicon-scissors"></span></h1>
        ...
        <div class="col-lg-12 col-md-6  col-sm-8 col-xs-12">
            ...
            <div class="text-center">
                <p>
                    ...
                    <a id="Reporte" href="#" class="boton-buscar">Imprimir</a>
                </p>
