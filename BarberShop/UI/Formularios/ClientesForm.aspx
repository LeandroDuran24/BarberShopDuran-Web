...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-6  col-sm-8 col-xs-12">
            ...
            <div class="text-center">
                <asp:TextBox ID="idClienteTextbox" runat="server" Width="190px" Height="33px" TextMode="Number" MaxLength="10"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="NombreClienteTextbox" runat="server" Width="300px" Height="33px" onkeypress="return soloLetras(event)" MaxLength="40"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="ApellidosTextBox1" runat="server" Width="300px" Height="33px" onkeypress="return soloLetras(event)" MaxLength="40"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="DireccionTextBox2" runat="server" Width="300px" Height="33px" MaxLength="75"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="CedulaTextBox3" runat="server" Width="300px" Height="33px" TextMode="Number" MaxLength="15"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox type="email" ID ="EmailTextBox4" runat="server" Width="300px" Height="33px" MaxLength="45" ></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="FechaTextBox5" runat="server" Width="300px" Height="33px" TextMode="DateTime"></asp:TextBox>
