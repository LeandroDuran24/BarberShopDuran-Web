    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-6  col-sm-8 col-xs-12">
            ...
            <div class="text-center">
                ...
                <asp:TextBox ID="idTextbox" runat="server" Width="190px" Height="33px" onkeypress="return soloNumeros(event)" TextMode="Number"></asp:TextBox>&nbsp
            ...
            <div class="text-center">
                <asp:TextBox ID="CostoTextBox1" runat="server" Width="300px" Height="33px" TextMode="Number"></asp:TextBox>
