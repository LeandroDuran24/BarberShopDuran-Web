    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-6  col-sm-8 col-xs-12">
            ...
            <div class="text-center">
                ...
                <asp:TextBox ID="idTextbox"  runat="server" Width="190px" Height="33px" ForeColor="Black" TextMode="Number" MaxLength="10"></asp:TextBox>&nbsp
            ...
            <div class="text-center">
                <asp:TextBox ID="NombreTextbox"  runat="server" Width="300px" Height="33px" onkeypress="return soloLetras(event)" MaxLength="20"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="emailTextbox"  runat="server" Width="300px" Height="33px" onkeypress="return soloLetras(event)" MaxLength="50"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox ID="fecha"  runat="server" Width="300px" Height="33px" TextMode="DateTime"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox  ID="claveTextbox" Type="password"  runat="server" Width="300px" Height="33px"  onkeypress="return soloNumeros(event)" MaxLength="15"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox  ID="confTextbox" Type="password" runat="server" Width="300px" Height="33px" MaxLength="15" ></asp:TextBox>
