...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-6  col-sm-8 col-xs-12">
            ...
            <div class="text-center">
                <asp:TextBox  ID="claveTextbox" Type="password"  runat="server" Width="300px" Height="33px"  onkeypress="return soloNumeros(event)"></asp:TextBox>
            ...
            <div class="text-center">
                <asp:TextBox  ID="confTextbox" Type="password" runat="server" Width="300px" Height="33px" ></asp:TextBox>
